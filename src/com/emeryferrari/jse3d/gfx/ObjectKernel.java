...
class ObjectKernel extends Kernel {
	...
	public ObjectKernel(Display display) {
		zAngleX = new float[display.settings.maxPointsTotal];
		zAngleY = new float[display.settings.maxPointsTotal];
		zAngleZ = new float[display.settings.maxPointsTotal];
		sinViewAngleXzAngle = new float[display.settings.maxPointsTotal];
		cosViewAngleXzAngle = new float[display.settings.maxPointsTotal];
		xTransforms = new float[display.settings.maxPointsTotal];
		yTransforms = new float[display.settings.maxPointsTotal];
		maths = new float[display.settings.maxPointsTotal];
		cosThetas = new float[display.settings.maxPointsTotal];
		sinViewAngles = new float[display.settings.maxPointsTotal];
	}
